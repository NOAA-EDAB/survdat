...
# pull raw data
raw <- survdat::get_survdat_data(channel, getLengths = F, conversion.factor = F)

# pull lengths
len <- survdat::get_survdat_data(channel, getLengths = T, conversion.factor = F)
# pull lengths with predicted weights
lenwgt <- survdat::get_survdat_data(
  channel,
  getLengths = T,
  getWeightLength = T,
  conversion.factor = F
...
rawfact <- survdat::get_survdat_data(
  channel,
  getLengths = F,
  conversion.factor = T
)
