...
#' @param aggregate vector. Spatial scale to aggregate by: "EPU", "strata", or "none".
...
# calc_condition(surveyData, channel, aggregate, by_sex, length_break)
...
grouping_vars <- c("Species", "YEAR", "EPU", "STRATUM")
