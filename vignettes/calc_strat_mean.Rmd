...
straightarrow(from = pos[5, ], to = pos[10, ] - c(0.06, 0), arr.pos = apos)

#Polygon/area flow
straightarrow(from = pos[12, ], to = pos[13, ] - c(0.06, 0), arr.pos = apos)
straightarrow(from = pos[13, ], to = pos[14, ] - c(0.06, 0), arr.pos = apos)
straightarrow(from = pos[14, ], to = pos[3, ] - c(0.06, 0), arr.pos = apos)

#Optional post stratify
straightarrow(from = pos[2, ],  to = pos[7, ] - c(0, 0.06), arr.pos = apos, lty = 3)
