...
The first function that is called is `strat_prep`.  As the name implies, `strat_prep` does some of the leg work necessary to calculate the stratified means.  Nested within `strat_prep` is the `post_strat` and `get_area` functions.
