...
#'@import rgdal
#'@export
poststrat <- function (survdat, stratum = 'EPU', strata.col = 'EPU', na.keep = F) {
...
#'@import data.table
#'@export
stratmean <- function (survdat, group.col, strat.col, nsta.col = 'ntows', area.wgt = 'W.h',
...
#'@import data.table
#'@export
sweptarea <- function (survdat, stratmean, q = NULL, a = 0.0384, strata.col, area.col, 
                       group.col = 'SVSPP') {
