# Extracted from test-get_species.R:23
...
expect_true(round(as.numeric(res$Area[1]) == 2023.492, digits = 3))
expect_true(round(as.numeric(res$Area[90]) == 619.285, digits = 3))
expect_true(round(as.numeric(res$Area[178]) == 195.237, digits = 3))
