...
if(Sys.info()['sysname']=="Linux"){
  ...
  out.dir  <- "/home/slucey/slucey/ATLANTIS/"
}
...
fall.GOM <- survdat[SEASON == 'FALL' & STRATUM %in% c(1220, 1240, 1260:1290, 1360:1400), ]

#Run stratification prep
GOM.prep <- stratprep(fall.GOM, strat.area, strat.col = 'STRATUM', area.col = 'Area')

#Calculate stratified means - can do multiple species at once (i.e. groups = c(72, 73, 75))
...
write.csv(total.biomass, file = paste(out.dir, 'Lobster_GoM.csv',   sep = ''), row.names = F)
